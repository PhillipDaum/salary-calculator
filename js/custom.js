...
const submitForm = (e) => {
    ...
    console.log("line 8", userArray);
    console.log(calculate(userArray));
...
const calculate = (array) => {
 ...
 you will be taxed <strong>$${theTaxRate}</strong>. That means that your net pay will be <strong>$${netPay}</strong> 
 per year, or <strong>$${monthlyNetPay}</strong> per month. Your average tax rate is <strong>${theTaxRate}%</strong> and your 
 marginal tax rate is <strong>${theMarginalTaxRate}%</strong>. This marginal tax rate means that your immediate additional 
